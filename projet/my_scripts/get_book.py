...
if 'https://books.toscrape.com/catalogue/' in recherche:
    url = recherche
    os.chdir(test_folder)
    ...
    print("Parfait, votre livre vient d'être téléchargé, rendez-vous dans le dossier 'downloads/books' pour le consulter\n")
